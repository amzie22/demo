...
const getCurrentLetter = (activity) => {
  ...
  if (activity >= 1 && activity <= 3) return 'Ba';
  if (activity >= 4 && activity <= 6) return 'Ka';
  if (activity >= 7 && activity <= 9) return 'Ra/Da';
        ...
        {choices.map((choice, index) => (
          ...
          >
            ...
            >
              ...
              {(type === 2 || type === 5 || type === 8) && choice === 'Ba'
                ? 'B'
                : (type === 2 || type === 5 || type === 8) && choice === 'Ka'
                ? 'K'
                : (type === 2 || type === 5 || type === 8) && choice === 'Ra/Da'
                ? 'R'
                : choice}
            </Text>
          </TouchableOpacity>
    ...
    <ImageBackground source={require('../../../assets/MainBG.png')} style={styles.background}>
                ...
                <View style={styles.modalButtonsVertical}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      navigation.navigate('Lesson3'); // Navigate to Lesson1
                    }}
                  >
      ...
      {currentActivity === 1 && (
        <Activity
          type={1}
          letter="Ba"
          displayLetter="B" // Display "A" in the big box
          choices={choices}
      ...
      {currentActivity === 4 && (
        <Activity
          type={1}
          letter="Ka" // Correct answer for activities 4-6
          displayLetter="K" // Display "E" in the big box
          choices={choices}
          title={getTitle(currentActivity)}
          onCorrect={handleCorrectAnswer}
          onWrong={handleWrongAnswer}
      ...
      {currentActivity === 6 && (
        <Activity
          type={3}
          letter="Ra/Da" // Correct answer for activities 4-6
          displayLetter="R"
          choices={choices}
          title={getTitle(currentActivity)}
          onCorrect={handleCorrectAnswer}
      ...
      {currentActivity === 7 && (
        <Activity
          type={1}
          letter="Ra/Da" // Correct answer for activities 7-9
          displayLetter="R" // Display "O" in the big box
          choices={choices}
          title={getTitle(currentActivity)}
          onCorrect={handleCorrectAnswer}
          onWrong={handleWrongAnswer}
