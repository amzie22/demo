...
const vowelsData = [
  { smallText: 'A', largeText: 'A', type: 1 }, // Type 1: With preview and big text
  { smallText: 'A', largeText: '', type: 2 },  // Type 2: Without preview and big text
  { smallText: 'E/I', largeText: 'E', type: 1 },
  { smallText: 'E/I', largeText: '', type: 2 },
  { smallText: 'O/U', largeText: 'O', type: 1 },
  { smallText: 'O/U', largeText: '', type: 2 },
];

const Act2 = ({ navigation }) => {
  ...
  const handleFinish = async () => {
    ...
    setTimeout(() => {
      navigation.navigate('LastEp2'); // Automatically navigate to "Challenges" after 10 seconds
    }, 10000);
  };
          ...
          <View style={styles.container}>
            {vowelsData[currentIndex].type === 1 && showPreview && (
              <Image
                source={
                  currentIndex === 0
                    ? require('../../../assets/syllables/A.gif')
                    : currentIndex === 2
                    ? require('../../../assets/syllables/EI.gif')
                    : currentIndex === 4
                    ? require('../../../assets/syllables/OU.gif')
                    : null
                }
                style={
                  currentIndex === 0
...
const styles = StyleSheet.create({
  ...
  gifA: {
    ...
    height: 220,
    position: 'absolute',
    top: 55, // Adjust position for A
    left: 40, // Adjust horizontal position for A
    zIndex: 2,
  },
  gifEI: {
    width: 268,
    height: 218,
    position: 'absolute',
    top: 79, // Adjust position for E/I
    left: 49, // Adjust horizontal position for E/I
    zIndex: 2,
  },
  gifOU: {
    width: 245,
    height: 190,
    position: 'absolute',
    top: 90, // Adjust position for O/U
    left: 60, // Adjust horizontal position for O/U
    zIndex: 2,
  },
