    ...
    <ImageBackground source={require('../../../assets/MainBG.png')} style={styles.background}>
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.goBack()}>
          ...
          <Text style={styles.headerText}>Chapter 2 Lesson 1</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.boxContainer}>
        ...
        <View style={styles.boxWrapper}>
          ...
          <Text style={styles.boxLabel}>E/I</Text>
        </View>
        <View style={styles.boxWrapper}>
          ...
          <Text style={styles.boxLabel}>O/U</Text>
        </View>
      </View>
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('Act1')}>
