    ...
    <ImageBackground source={require('../../../assets/MainBG.png')} style={styles.background}>
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.goBack()}>
          ...
          <Text style={styles.headerText}>Chapter 2 Lesson 4</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.line} />
      <View style={styles.textContainer}>
        <Text style={styles.chapterText}>Chapter 2</Text>
        <Text style={styles.lessonText}>LESSON 4</Text>
          ...
          {currentBox === 1 && (
            <>
              ...
              <Image
                ...
                source={require('../../../assets/syllables/Ba_inv.gif')}
                style={styles.boxGif}
              />
            </>
          )}
          {currentBox === 2 && (
            <>
              ...
              <Image
                ...
                source={require('../../../assets/syllables/Ka_inv.gif')}
                style={styles.boxGif}
              />
            </>
          )}
          {currentBox === 3 && (
            <>
              ...
              <Image
                ...
                source={require('../../../assets/syllables/RaDa_inv.gif')}
                style={styles.boxGif}
              />
            </>
          )}
      ...
      {/* Start Button */}
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('Act4')}>
